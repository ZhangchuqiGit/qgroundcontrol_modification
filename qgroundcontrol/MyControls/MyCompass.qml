...
//                    ctx.strokeRect(0,0,width,height)
                    ...
                    ctx.lineTo(outerRadius * 0.01,height * 0.45)
                    ctx.lineTo(outerRadius * 0.01,height * 0.5)
                    ctx.lineTo(width * 0.4,height * 0.5)
                    ctx.stroke()
                    //绘制飞机右边机翼
                    ctx.beginPath()
                    ctx.moveTo(width * 0.6,height * 0.3)
                    ctx.lineTo(width-outerRadius * 0.01,height * 0.45)
                    ctx.lineTo(width-outerRadius * 0.01,height * 0.5)
            ...
            foreground: Item {
                ...
                Rectangle {
                    ...
                    anchors.rightMargin: outerRadius * 1/8
