...
Item {
	...
	QGCFlickable {
		...
		Column {
			id:                 settingsColumn
			width:              _root.width
			spacing:            4 // ScreenTools.defaultFontPixelHeight * 0.5
			anchors.margins:    ScreenTools.defaultFontPixelWidth
			//-----------------------------------------------------------------
			//-- General
			Item {
			...
			Rectangle {
				...
				GridLayout {
					...
					rowSpacing:         4 // ScreenTools.defaultFontPixelHeight * 0.25
					anchors.centerIn:   parent
			...
			Rectangle {
				...
				GridLayout {
					...
					rowSpacing:         4 // ScreenTools.defaultFontPixelWidth  * 0.25
					anchors.centerIn:   parent
