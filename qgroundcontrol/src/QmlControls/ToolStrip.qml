...
Rectangle {
    ...
    property real   maxHeight:           0 ///< Maximum height for control, determines whether text is hidden to make control shorter
    ...
    function simulateClick(buttonIndex) {
        //		zcq.echo("simulateClick(" + buttonIndex + ")" + zcqfile)
        if (buttonIndex >= 0) {
    ...
    property real _idealWidth: (ScreenTools.isMobile ?
                                    ScreenTools.minTouchPixels : ScreenTools.defaultFontPixelWidth * 5) + toolStripColumn.anchors.margins * 2
    ...
    QGCFlickable {
        id:                 flickable
        anchors.margins:    2 // ScreenTools.defaultFontPixelWidth * 0.4
       ...
       // anchors.verticalCenter: parent.verticalCenter
        ...
        Column {
            ...
            anchors.left:   parent.left
            anchors.right:  parent.right
            spacing:       2 // ScreenTools.defaultFontPixelWidth * 0.25
