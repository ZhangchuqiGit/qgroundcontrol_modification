...
RowLayout {
    ...
    Column {
        ...
        Column {
			QGCLabel { text: qsTr("Tuning Axis:") }//调参轴：
		...
		QGCLabel { text: qsTr("Tuning Values:") }//调参值：
        ...
        RowLayout {
			QGCLabel { text: qsTr("Increment/Decrement %") }//增/减量
        ...
        Column {
			QGCLabel { text: qsTr("Clipboard Values:") }//剪贴板值：
        ...
        RowLayout {
            ...
            QGCButton {
				text:       qsTr("Save To Clipboard")//复制到剪贴板
                onClicked:  saveTuningParamValues()
            }

            QGCButton {
				text:       qsTr("Restore From Clipboard")//从剪贴板还原
