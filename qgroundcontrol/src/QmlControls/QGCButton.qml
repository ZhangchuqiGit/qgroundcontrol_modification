...
Button {
	...
	property int _horizontalPadding:    1
	property int _verticalPadding:      1
	...
	style: ButtonStyle {
		...
		label: Item {
			...
			QGCColoredImage {
				...
				anchors.leftMargin:     control.iconLeft ? _horizontalPadding : undefined
				anchors.right:          !control.iconLeft ? parent.right : undefined
				anchors.rightMargin:    !control.iconLeft ? _horizontalPadding : undefined
			...
			Text {
				...
				anchors.verticalCenter: parent.verticalCenter
				anchors.horizontalCenter: control.iconLeft ?
											  parent.horizontalCenter :
											  !control.textLeft ? parent.horizontalCenter : undefined
				anchors.left:			!control.iconLeft ?
											control.textLeft ? parent.left : undefined : undefined
				antialiasing:           true
				text:                   control.text
