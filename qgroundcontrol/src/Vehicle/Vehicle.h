...
public:
	...
	/********************* zcq **********************/
	Q_PROPERTY(quint64 time_usec READ time_usec NOTIFY time_usecChanged)
	Q_PROPERTY(QVariantList motor_current READ motor_current NOTIFY motor_currentChanged)
	Q_PROPERTY(QVariantList motor_temperature READ motor_temperature NOTIFY motor_temperatureChanged)
	Q_PROPERTY(QVariantList motor_speed READ motor_speed NOTIFY motor_speedChanged)
	Q_PROPERTY(float battery_voltage READ battery_voltage NOTIFY battery_voltageChanged)

	quint64 time_usec() const {return _time_usec;}
	QVariantList motor_current() const {return _motor_current;}
	QVariantList motor_temperature() const {return _motor_temperature;}
	QVariantList motor_speed() const {return _motor_speed;}
...
signals:
	//触发信号，QML前端中接收， ---- zcq
	void time_usecChanged(quint64 _time_usec);
	void motor_currentChanged(QVariantList arg);
	void motor_temperatureChanged(QVariantList arg);
	void motor_speedChanged(QVariantList arg);
	void battery_voltageChanged(float _battery_voltage);
...
private:
	/******************* zcq QGC中接收函数 ************/
	void _handle_ZcqMavlinkTestRct      (mavlink_message_t& message);	/* zcq */
	quint64 _time_usec;
	QVariantList _motor_current;
	QVariantList _motor_temperature;
	QVariantList _motor_speed;
