...
SetupPage {
	...
	Component {
		...
		Item {
			...
			property real _imageHeight:     ScreenTools.defaultFontPixelHeight * 2.5
			property real _imageWidth:      _imageHeight * 2.0
			...
			ColumnLayout {
				...
				QGCLabel {
					text:                   qsTr("Low Battery Failsafe Trigger")//低电量故障保护触发器
					color: "deepskyblue"
				}
				...
				Rectangle {
					...
					Row {
						...
						GridLayout {
							...
							anchors.verticalCenter: parent.verticalCenter
							QGCLabel {
								text:               qsTr("Failsafe Action:")//故障保护动作：
							...
							QGCLabel {
								text:               qsTr("Battery Warn Level:")//电量警告水平：
								Layout.fillWidth:   true
							}
							FactTextField {
							...
							QGCLabel {
								text:               qsTr("Battery Failsafe Level:")//电量故障保护水平：
								Layout.fillWidth:   true
							}
							FactTextField {
							...
							QGCLabel {
								text:               qsTr("Battery Emergency Level:")//电量紧急水平：
								Layout.fillWidth:   true
							}
							FactTextField {
				...
				QGCLabel {
					text:                   qsTr("RC Loss Failsafe Trigger")//遥控器信号丢失故障保护触发器
					color: "deepskyblue"
				}
