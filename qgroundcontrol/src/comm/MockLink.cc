...
/******************** zcq ***********************/
void MockLink::_handle_ZcqMavlinkTest(const mavlink_message_t& msg) /* zcq */
{
	mavlink_vehicle_safety_status_t vehicle_safety_status_t;
	mavlink_msg_vehicle_safety_status_decode(&msg, &vehicle_safety_status_t);

	//	qDebug() << "time_usec\t\t" << vehicle_safety_status_t.time_usec;
	//	qDebug() << "motor_speed\t\t" << vehicle_safety_status_t.motor_speed;
	//	qDebug() << "motor_current\t\t" << vehicle_safety_status_t.motor_current;
	//	qDebug() << "battery_voltage\t\t" << vehicle_safety_status_t.battery_voltage;
	//	qDebug() << "motor_temperature\t\t" << vehicle_safety_status_t.motor_temperature;
}
