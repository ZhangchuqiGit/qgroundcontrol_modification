...
Item {
    ...
    Component {
        ...
        Rectangle {
			width:  battCol.width   + ScreenTools.defaultFontPixelWidth * 1.1
			height: battCol.height  + ScreenTools.defaultFontPixelHeight * 1.1
            ...
            Column {
                id:                 battCol
				spacing:            2 // ScreenTools.defaultFontPixelHeight * 0.4
                ...
                GridLayout {
                    id:                 battGrid
					anchors.margins:   2 //  ScreenTools.defaultFontPointSize * 0.3
					columnSpacing:      2 // ScreenTools.defaultFontPointSize * 0.3
                    columns:            2
                    anchors.horizontalCenter: parent.horizontalCenter
